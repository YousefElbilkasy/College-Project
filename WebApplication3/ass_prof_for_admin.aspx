<%@ Page Title="" Language="C#" MasterPageFile="~/admin_dashboard.master" AutoEventWireup="true" CodeBehind="ass_prof_for_admin.aspx.cs" Inherits="WebApplication3.ass_prof_for_admin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PrivateStyle2" runat="server">
  <link href="css/ass_prof_for_admin.css" rel="stylesheet" />
</asp:Content>
    ...
    <ItemTemplate>
      <div class="student-card">
        <div class="student-card-header">
          <p class="student-card-id"><%# Eval("AssistantProfessorID") %> :</p>
    ...
    <div class="modal">
      ...
      <div class="modal-content-center">
        <div class="modal-header">
          ...
          <h2>Add Assistant Professor</h2>
          <div class="label">
            <asp:Label ID="lblMessageForAssProf" runat="server" ForeColor="Red"></asp:Label>
          </div>
        </div>
        ...
        <div class="modal-footer">
          <asp:Button
            ID="btnAddStudent"
            runat="server"
            Text="Add Assistant Professor"
            OnClick="btnAddAssistantProfessor_Click"
