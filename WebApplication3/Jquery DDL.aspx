    ...
    <form id="form1" runat="server">
        <div>
            <center>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectDataConnectionString %>" ProviderName="<%$ ConnectionStrings:ProjectDataConnectionString.ProviderName %>" SelectCommand="SELECT [FirstName] FROM [AssistantProfessors]"></asp:SqlDataSource>
            </center>
        </div>
        <script>
